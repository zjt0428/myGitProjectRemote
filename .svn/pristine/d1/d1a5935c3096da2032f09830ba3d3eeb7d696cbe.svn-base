 ...
 * All right reserved. 
 *====================================================
 * 文件名称: AppUserKeyLogService.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
...
/**
 * @ClassName: AppUserKeyLogService
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2012-11-2 下午3:10:24
 */
public interface AppUserKeyLogService extends BaseLongPKService<AppUserKeyLog> {
