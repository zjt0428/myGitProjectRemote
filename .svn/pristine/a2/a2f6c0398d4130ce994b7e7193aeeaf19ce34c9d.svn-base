var ContractSubcontractDetailForm = function(a, b) {
	Ext.apply(this, a || {});
	Ext.apply(this, b || {});
			...
			items : [ {
				...
				handler : function() {
					Ext.Ajax.request({
						...
						form : "contractSubcontractDetail",
						method : "post",
						async : true,
						isUpload : true,
				...
				text : "重置",
				handler : function() {
					document.getElementById("contractSubcontractDetail").reset();
				}
			} ]
		});
	}
	ContractSubcontractDetailForm.superclass.constructor.call(this, {
		layout : "fit",
		iconCls : "menu-set-department",
		width : 930,
		height : 500,
		tbar : this.topbar,
		autoLoad : __ctxPath + "/dispatch/detailContractLease.do?formpage=detailContractSubcontract&contractId=" + this.contractId,
		border : false,
		maximizable : true,
		modal : true,
		plain : true,
...
Ext.extend(ContractSubcontractDetailForm, Ext.Window, {});