...
/**
 * @ClassName: SettleContractDao
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-9-24 下午5:06:32
 */
public interface SettleContractRecordDao extends BaseBusinessModelDao<SettleContractRecord> {
