var OtherLeaseDetailGrid = function(a, b) {
	Ext.apply(this, a || {});
	Ext.apply(this, b || {});
	...
	OtherLeaseDetailGrid.superclass.constructor.call(this, Ext.apply({
		...
		height : this.height,
		columns : columns,
		delurl : __ctxPath + "/materials/multiDelDetailOtherLeaseBusiness.do"
	}, this.viewConfig || {}));
};
Ext.extend(OtherLeaseDetailGrid, Knight.ux.SubModuleBaseGrid, {
	change : function(){
		var total = 0;
