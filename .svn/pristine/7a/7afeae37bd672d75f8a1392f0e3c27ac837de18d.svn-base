var BeforeRemodelGrid = function(a,b) {
	Ext.apply(this, a||{});
	Ext.apply(this, b||{});
	this.params = {};
	...
	BeforeRemodelGrid.superclass.constructor.call(this, Ext.apply({
		...
		height : this.height,
		fields : ["beforeId","materialsSpecifications","baseLocation","quantity"],
		columns : columns,
		delurl : __ctxPath + "/materials/multiDelBeforeMaterialsRemodel.do",
	}, this.grid_config || {}));
};
Ext.extend(BeforeRemodelGrid, Knight.ux.SubModuleBaseGrid, {	
