...
/**
 * @ClassName: DeductDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-17 下午4:19:52
 */
public class DeductDaoImpl extends BaseBusinessModelDaoImpl<Deduct> implements DeductDao {
