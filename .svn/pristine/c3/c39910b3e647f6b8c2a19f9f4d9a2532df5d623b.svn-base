...
/**
 * @ClassName: LeaseSettlementInsideBlockUp
 * @Description: 【租借结算】内部报停清单
 * @author chenzj
 * @date 2018-8-15
 */
@Entity
...
@Table(name = "T_LEASE_SETTLEMENT_INSIDE_BLOCK_UP")
public class LeaseSettlementInsideBlockUp extends BaseModel {
