/**
 *====================================================
 * 文件名称: RentItemBriefDaoImpl.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
...
/** 
 * @ClassName: RentItemBriefDaoImpl 
 * @Description: TODO(这里用一句话描述这个类的作用) 
 * @author chenxy 
 * @date 2015年4月11日 下午11:14:28  
 */
public class RentItemBriefDaoImpl extends BaseLongPKDaoImpl<RentItemBrief> implements RentItemBriefDao {
