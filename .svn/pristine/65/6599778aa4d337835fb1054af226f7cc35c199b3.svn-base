...
/**
 * @ClassName: SafeClarificationDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-7 下午11:14:37
 */
public class SafeClarificationDaoImpl extends BaseLongPKDaoImpl<SafeClarification> implements SafeClarificationDao {
