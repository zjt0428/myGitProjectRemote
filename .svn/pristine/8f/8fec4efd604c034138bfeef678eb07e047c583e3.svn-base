var SafetyMonitorSettleListVersionGrid = function(a, b) {
	Ext.apply(this, a || {});
	Ext.apply(this, b || {});
	...
	SafetyMonitorSettleListVersionGrid.superclass.constructor.call(this, Ext.apply({
		saveable : this.saveable,
		fields : SafetyMonitorSettleVersionListViewField,
		title : "安全监控系统结算清单",
		option : "安全监控系统结算清单",
		addForbidden : true,
		delForbidden : true,
		...
		height : this.height,
		columns : columns,
		delurl : __ctxPath + "/dispatch/multiDelSafetyMonitorSettleContractVersion.do"
	}, this.grid_config || {}));
};
Ext.extend(SafetyMonitorSettleListVersionGrid, Knight.ux.SubModuleBaseGrid, {
