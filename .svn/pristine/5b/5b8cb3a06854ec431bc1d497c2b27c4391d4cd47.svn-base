var PersonnelAuthorization4BasedepotForm = function(a) {
	Ext.apply(this, a);
	this.params =  {};
	...
	PersonnelAuthorization4BasedepotForm.superclass.constructor.call(this, Ext.apply({
		id : "PersonnelAuthorization4BasedepotForm",
		title : "人员授权",
		iconCls : "menu-set-user",
		url :  __ctxPath + "/materials/listOnDepotIdBaseDepot.do",
...
Ext.extend(PersonnelAuthorization4BasedepotForm, Knight.ux.SearchGridPanel, {
			...
			collectEnable : true,
					callback : function(d) {
						...
						$request({
							...
							url :  __ctxPath + "/materials/importUserBaseDepot.do",
							success : function() {
								this.dataGridPanel.getStore().reload();
							}.createDelegate(this)
						});
	...
	delAppUser : function() {
		...
		this.speciallyGridAction(this.dataGridPanel, "joinId", __ctxPath + "/materials/removeUserBaseDepot.do", "删除", function(a) {
			return true;
		}.createDelegate(this));
	},
});