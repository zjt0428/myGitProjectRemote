...
/**
 * @ClassName: IndisSchemaDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2014-4-20 上午8:25:43
 */
public class IndisSchemaDaoImpl extends BaseBusinessModelDaoImpl<IndisSchema> implements IndisSchemaDao {
