 ...
 */
public class PractiCertServiceImpl extends BusinessLongPKServiceImpl<PractiCert> implements PractiCertService {

	public PractiCertServiceImpl(PractiCertDao dao) {
		super(dao);
	}
