var DataPermissionView = function(a) {
	Ext.apply(this, a);
	this.params = {};
	...
	DataPermissionView.superclass.constructor.call(this, Ext.apply({
		id : "DataPermissionView",
		title : "数据权限",
...
Ext.extend(DataPermissionView, Knight.ux.SearchGridPanel, {
	...
	deleteDepartment : function() {
		...
		Ext.Msg.confirm("删除操作", "你确定删除权限?", function(p) {
			if (p == "yes") {
				$request({
