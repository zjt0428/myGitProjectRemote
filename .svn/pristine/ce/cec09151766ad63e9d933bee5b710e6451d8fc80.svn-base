...
/**
 * @ClassName: InvoiceIssueService
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-17 下午4:24:01
 */
public interface InvoiceIssueService extends BusinessFlowService<InvoiceIssue> {
