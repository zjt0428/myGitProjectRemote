...
/**
 * @ClassName: BorrowEquipDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-12 上午11:05:42
 */
public class BorrowEquipDaoImpl extends BaseLongPKDaoImpl<BorrowEquip> implements BorrowEquipDao {
