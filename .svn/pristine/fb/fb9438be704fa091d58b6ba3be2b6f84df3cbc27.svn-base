var LogisticsTransportSelector = function(a) {
	Ext.apply(this, a || {});
	this.params = {};
	...
	LogisticsTransportSelector.superclass.constructor.call(this, {
		configView : {
			title : "物流信息选择"
		},
		source : {
...
Ext.extend(LogisticsTransportSelector, Knight.ux.RelationSelector, {});