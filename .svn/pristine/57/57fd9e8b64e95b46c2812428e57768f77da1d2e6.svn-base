 ...
 * @date 2017年7月14日
 */
public class MaterialsStoreServiceImpl extends BusinessLongPKServiceImpl<MaterialsStore> implements MaterialsStoreService {

	@Resource
	private MaterialsStoreDao materialsStoreDao;
	
	public MaterialsStoreServiceImpl(MaterialsStoreDao dao) {
		super(dao);
		this.materialsStoreDao = dao;
	}
