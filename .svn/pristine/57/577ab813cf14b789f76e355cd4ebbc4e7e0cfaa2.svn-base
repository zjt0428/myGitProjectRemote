/**
 *====================================================
 * 文件名称: TechnicalDisclosureService.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
...
/**
 * @ClassName: TechnicalDisclosureService
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2014-4-20 上午8:30:40
 */
public interface TechnicalDisclosureService extends BaseBusinessModelService<TechnicalDisclosure> {
