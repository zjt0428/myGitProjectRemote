/**
 *====================================================
 * 文件名称: ContractArrangeDaoImpl.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
...
/** 
 * @ClassName: ContractArrangeDaoImpl 
 * @Description: TODO(这里用一句话描述这个类的作用) 
 * @author chenxy 
 * @date 2015年4月1日 下午5:45:35  
 */
public class ContractArrangeDaoImpl extends BaseBusinessModelDaoImpl<ContractArrange> implements ContractArrangeDao {
