 ...
 * </code></pre>
 */
var ContractEquipBriefGrid = function(a, b) {
	Ext.apply(this, a || {});
	Ext.apply(this, b || {});
	...
	var columns = [/*{
		...
		tooltip: '<font color=red>未发货的设备可修改</font>',
	...
	ContractEquipBriefGrid.superclass.constructor.call(this, Ext.apply({
...
Ext.extend(ContractEquipBriefGrid, Knight.ux.SubModuleBaseGrid, {
	...
	beforeedit : function(grid) {
		...
		|| (grid.record.data.dispatchable !== '0' && !(grid.field=='equipGeneric' || grid.field=='equipSpecificName'));  
	}
});