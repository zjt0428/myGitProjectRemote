...
/**
 * @ClassName: VerifyStandardDao
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-10-5 下午10:59:01
 */
public interface VerifyStandardDao extends BaseLongPKDao<VerifyStandard> {
