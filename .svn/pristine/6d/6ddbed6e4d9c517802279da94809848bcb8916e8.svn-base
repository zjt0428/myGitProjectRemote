...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="listtable">
  ...
  <tr>
    <td height="30" colspan="4" align="left" bgcolor="#E0E0E0">&nbsp;<strong>项目未安装明细</strong></td>
  </tr>
  <tr>
    <td colspan="4"  style="border-bottom-style:none; padding:0px;">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <c:forEach var="element" items="${unusedGather}" varStatus="status">
      <tr>
        <td height="30" style=" border-left-style:none;">&nbsp;${element["COMPON_GENERIC"]}</td>
	  ...
	  <c:if test="${fn:length(unusedGather) <= 0 }">
	  <tr>
        <td height="30" style=" border-left-style:none;" colspan="5">&nbsp;----</td>
      </tr>
	  </c:if>
  ...
  <tr>
    <td height="30" colspan="4" align="left"><strong>其他零星部件</strong></td>
  </tr>
  <tr>
    <td height="60" colspan="4" align="left">&nbsp;</td>
  </tr>
  <tr>
