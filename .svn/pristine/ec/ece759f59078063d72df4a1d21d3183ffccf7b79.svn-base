...
/**
 * @ClassName: ContractArrangeServiceImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2015年4月1日 下午5:48:34
 */
public class ContractArrangeServiceImpl extends BusinessFlowServiceImpl<ContractArrange> implements ContractArrangeService {
	...
	public ContractArrangeServiceImpl(ContractArrangeDao dao) {
		super(dao);
		this.contractArrangeDao = dao;
	}

	public void saveOrMergeForEdit(ContractArrange contractArrange) {
		if (contractArrange.getArrangeId() == null) {
			super.saveSerialModel(contractArrange);
		}
		contractArrange.setSubContractArrange();
		contractArrangeDao.merge(contractArrange);
	}
