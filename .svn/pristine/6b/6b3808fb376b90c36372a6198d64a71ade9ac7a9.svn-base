...
/**
 * @ClassName: CostDetailDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author 
 * @date 
 */
public class TemporaryReturnDetailDaoImpl extends BaseLongPKDaoImpl<TemporaryReturnDetail> implements TemporaryReturnDetailDao {
