/**
 *====================================================
 * 文件名称: DismantleManageDaoImpl.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
...
/**
 * @ClassName: DismantleManageDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2014-10-26 下午4:20:15
 */
public class DismantleManageDaoImpl extends BaseLongPKDaoImpl<DismantleManage> implements DismantleManageDao {
