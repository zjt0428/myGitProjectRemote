/**
 *====================================================
 * 文件名称: InspectManageDaoImpl.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
...
/** 
 * @ClassName: InspectManageDaoImpl 
 * @Description: TODO(这里用一句话描述这个类的作用) 
 * @author chenxy 
 * @date 2014年10月31日 下午9:14:56  
 */
public class InspectManageDaoImpl extends BaseLongPKDaoImpl<InspectManage> implements InspectManageDao {
