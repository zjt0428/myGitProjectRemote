/**
 *====================================================
 * 文件名称: CustomerLinkerDaoImpl.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
...
/**
 * @ClassName: CustomerLinkerDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-5 下午5:29:45
 */
public class CustomerLinkerDaoImpl extends BaseLongPKDaoImpl<CustomerLinker> implements CustomerLinkerDao {
