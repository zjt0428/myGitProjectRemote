var LeaseSettlementBlockUpGrid = function (a, b) {
	Ext.apply(this, a || {});
	Ext.apply(this, b || {});
	...
	LeaseSettlementBlockUpGrid.superclass.constructor.call(this, Ext.apply({
		title : "租借报停费用清单",
...
Ext.extend(LeaseSettlementBlockUpGrid, Knight.ux.SubModuleBaseGrid, {
	...
	accumulationAmount : function () {
		var total = 0;
		for (var i = 0; i < this.getStore().getCount(); i++) {
			total += (this.getStore().getAt(i).data.settledAmount) * 10e5;
		}
		return total / 10e5;
	},
