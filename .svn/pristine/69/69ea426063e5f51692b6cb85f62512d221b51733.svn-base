...
/**
 * @ClassName: TeamsAccountKnot
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2015年3月30日 下午11:36:53
 */
@Data
@EqualsAndHashCode(callSuper = false)
@ToString(callSuper = false, doNotUseGetters = true)
@PersistantDeclare
public class TeamsAccountKnot extends BaseModel {

	private static final long serialVersionUID = 1L;

	@Expose
	private Long accountKnotId;
	...
	@Expose
	@CodeFieldDeclare(codeId = "COMPON_JACKING_STATUS", valueField = "knotTypeName")
	private String knotType;

	@Expose
	private String knotTypeName;
