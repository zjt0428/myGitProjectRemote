var CopyToMyListView = function(a) {
	Ext.apply(this, a || {});
	this.params = {};
	this.userId = "";
	...
	if (!this.searchDisenable) {
		generalItems = [flowTypeCombo,stateNameCombo,{
			...
			lable : "审批人",
			name : "Q_instance.chkUserName_S_LK"
		},{
			lable : "申请人",
	...
	var datagrid_config = {
		...
		columns : [{
			...
			header : "当前审批人",
			dataIndex : "instance.chkUserName"
		}]
	};
	CopyToMyListView.superclass.constructor.call(this, Ext.apply({
		id : "CopyToMyListView",
		title : TabTitle.COPYTOME_VIEW,
		iconCls : "menu-info",
		url : __ctxPath + "/app/listFlow.do?TYPE=3&userId="+this.userId,
...
Ext.extend(CopyToMyListView, Knight.ux.SearchGridPanel, {
	initTopBarActionItems : function() {
		var tbarItems = [];
		tbarItems.push("->");
		if (isGranted("_CopyExporter")) {
			tbarItems.push({
