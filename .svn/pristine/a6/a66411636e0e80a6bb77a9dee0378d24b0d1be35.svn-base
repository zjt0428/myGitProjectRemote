...
/**
 * @ClassName: PractiDiaryDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-14 下午1:26:54
 */
public class PractiDiaryDaoImpl extends BaseLongPKDaoImpl<PractiDiary> implements PractiDiaryDao {
