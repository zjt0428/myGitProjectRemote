...
/**
 * @ClassName: EquipFlowDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-14 下午4:36:33
 */
public class EquipFlowDaoImpl extends BaseLongPKDaoImpl<EquipFlow> implements EquipFlowDao {
