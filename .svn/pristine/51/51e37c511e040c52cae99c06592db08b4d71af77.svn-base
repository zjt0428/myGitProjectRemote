/**
 *====================================================
 * 文件名称: ReimburseTicketDaoImpl.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
...
/**
 * @ClassName: ReimburseTicketDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-17 下午4:21:19
 */
public class ReimburseTicketDaoImpl extends BaseLongPKDaoImpl<ReimburseTicket> implements ReimburseTicketDao {
