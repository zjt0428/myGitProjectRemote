...
/**
 * @ClassName: EquipInstallDao
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-14 下午1:21:45
 */
public interface EquipInstallReviewDao extends BaseLongPKDao<EquipInstallReview> {
