...
<p align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="jsjtable">
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="98" style="border-bottom-style:none;" align="right">${technicalDisclosure.height}&nbsp;</td>
        <td width="40" style="border-bottom-style:none;"><strong>臂长</strong></td>
        <td width="75" style="border-bottom-style:none;" align="right">${technicalDisclosure.brachium}&nbsp;</td>
      </tr>
    </table></td>
    </tr>
  <tr>
  ...
  <tr>
    <td height="300" colspan="4" align="center" valign="top" style="padding-top:5px;"><p align="center"><strong>其他交底内容</strong></br><strong>${technicalDisclosure.replenishContents}</strong></p></td>
    </tr>
  <tr>
