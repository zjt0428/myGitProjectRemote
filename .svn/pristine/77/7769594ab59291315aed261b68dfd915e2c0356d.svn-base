...
public class Demo {
	...
	public void sendIOSUnicast() throws Exception {
		...
		// TODO Set your device token
		unicast.setDeviceToken("1e44d40dbef0cce0f7265eb54b01b7b7efdb7d3a7f6e002485dd63005a8f3c82");
        ...
        unicast.setCustomizedField("title", "测试标题" );
        unicast.setCustomizedField("content", "测试内容----------------------------------------" );
		client.send(unicast);
	}
	...
	public static void main(String[] args) {
		...
		Demo demo = new Demo("580200bfe0f55a2e9e002096", "z2n3rh0kppnojdxuhzuf2mxv0q8wbwto");
		try {
