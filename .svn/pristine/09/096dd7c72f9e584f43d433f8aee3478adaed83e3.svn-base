...
/**
 * @ClassName: EquipHitchDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2014-5-6 下午10:56:03
 */
public class EquipHitchDaoImpl extends BaseBusinessModelDaoImpl<EquipHitch> implements EquipHitchDao {
