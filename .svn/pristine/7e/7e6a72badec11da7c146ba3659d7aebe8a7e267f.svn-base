var IndisNoticePractiGrid = function(a, b) {
	Ext.apply(this, a || {});
	Ext.apply(this, b || {});
	...
	IndisNoticePractiGrid.superclass.constructor.call(this, Ext.apply({
		saveable : this.saveable,
		selectable : this.selectable,
		fields : IndisNoticePractiListViewField,
		title : "安排人员",
		option : "方案人员",
		tbarItems : this.tbarItems,
		height : this.height,
		columns : columns,
		delurl : __ctxPath + "/safety/multiDelPractiIndisNotice.do"
	}, this.grid_config || {}));
};
Ext.extend(IndisNoticePractiGrid, Knight.ux.SubModuleBaseGrid, {
