...
import com.knight.app.dao.TFlowDefineDao;
 ...
 */
public class TFlowDefineServiceImpl  extends BusinessLongPKServiceImpl<TFlowDefine> implements TFlowDefineService {

	private TFlowDefineDao tflowDefineDao;

	public TFlowDefineServiceImpl(TFlowDefineDao dao) {
		super(dao);
		this.tflowDefineDao = dao;
	}

	public void saveOrUpdate(TFlowDefine tflowDefine) {
		if (tflowDefine.getFlowid() == null) {
			tflowDefineDao.save(tflowDefine);
		}else{
			tflowDefineDao.merge(tflowDefine);
		}
	}
