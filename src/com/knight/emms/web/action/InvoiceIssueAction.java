...
public class InvoiceIssueAction extends BaseAction {
	...
	public String load() {
		Long ci = Long.valueOf(getRequest().getParameter("contractId"));
		List<Map<String, Object>> cmlist = invoiceIssueService.queryByScript("settle.get_settle_contract_invoice_relate_equip", DateUtil.getCurrentLinkDateStr());
		StringBuffer sb = new StringBuffer("{success:true,data:[");
		sb.append(GsonUtil.toJson(sb, GsonUtil.SINCE_VERSION_20, false));
		sb.append("]}");
