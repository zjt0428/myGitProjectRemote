...
public class ListenApply8 extends  ListenOverTime<TAppRepair>{
	...
	public void deal() {
		...
		send("注意，"+repair.getProjName()+"项目"+repair.getBuildingNum()+"号楼"+repair.getExwSerial()+"设备发生故障申报已经超过8小时未处理",repair.getProcMan());
	}
