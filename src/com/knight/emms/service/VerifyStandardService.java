 ...
 *====================================================
 * 文件名称: VerifyStandardService.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
...
/**
 * @ClassName: VerifyStandardService
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-10-6 下午2:36:07
 */
public interface VerifyStandardService extends BusinessLongPKService<VerifyStandard> {
