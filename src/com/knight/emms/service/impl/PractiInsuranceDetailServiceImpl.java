 ...
 */
public class PractiInsuranceDetailServiceImpl extends BusinessLongPKServiceImpl<PractiInsuranceDetail> implements PractiInsuranceDetailService {
	
	@Resource
	private PractiInsuranceDetailDao  practiInsuranceDetailDao;

	public PractiInsuranceDetailServiceImpl(GenericDao<PractiInsuranceDetail, Long> dao) {
		super(dao);
		// TODO Auto-generated constructor stub
	}

	@Override
	public List<PractiInsuranceDetail> getTranslateFull(QueryFilter queryFilter) {
		List<PractiInsuranceDetail> list = practiInsuranceDetailDao.getAll(queryFilter);
		for (PractiInsuranceDetail d : list) {
