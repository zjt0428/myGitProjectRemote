...
/**
 * @ClassName: MaterialsRepairDao
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-14 下午1:20:18
 */
public interface MaterialsRepairDao extends BaseBusinessModelDao<MaterialsRepair> {
