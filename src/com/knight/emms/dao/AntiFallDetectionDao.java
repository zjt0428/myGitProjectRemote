...
/**
 * @ClassName: EquipDetectDao
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-14 下午1:16:55
 */
public interface AntiFallDetectionDao extends BaseBusinessModelDao<AntiFallDetection> {
