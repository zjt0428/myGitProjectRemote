...
/**
 * @ClassName: BusinessMessageDao
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-25 下午2:27:50
 */
public interface BusinessMessageDao extends BaseLongPKDao<BusinessMessage> {
