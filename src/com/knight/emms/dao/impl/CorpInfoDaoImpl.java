...
/**
 * @ClassName: CorpInfoDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-4 上午11:03:23
 */
public class CorpInfoDaoImpl extends BaseLongPKDaoImpl<CorpInfo> implements CorpInfoDao {
