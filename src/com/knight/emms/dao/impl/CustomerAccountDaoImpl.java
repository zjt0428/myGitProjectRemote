/**
 *====================================================
 * 文件名称: CustomerAccountDaoImpl.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
 ...
 * @author chenxy
 * @date 2013-7-5 下午5:29:27
 */
public class CustomerAccountDaoImpl extends BaseLongPKDaoImpl<CustomerAccount> implements CustomerAccountDao {
