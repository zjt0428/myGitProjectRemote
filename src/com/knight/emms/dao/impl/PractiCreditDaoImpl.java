...
/**
 * @ClassName: PractiCreditDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-8-6 下午6:26:11
 */
public class PractiCreditDaoImpl extends BaseLongPKDaoImpl<PractiCredit> implements PractiCreditDao {
