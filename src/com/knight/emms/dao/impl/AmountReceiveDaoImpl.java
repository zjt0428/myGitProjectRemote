/**
 *====================================================
 * 文件名称: AmountReceiveDaoImpl.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
...
/**
 * @ClassName: AmountReceiveDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-17 下午4:19:13
 */
public class AmountReceiveDaoImpl extends BaseBusinessModelDaoImpl<AmountReceive> implements AmountReceiveDao {
