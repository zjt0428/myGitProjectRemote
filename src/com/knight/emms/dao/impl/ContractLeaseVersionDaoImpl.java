/**
 *====================================================
 * 文件名称: ContractLeaseDaoImpl.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
...
/**
 * @ClassName: ContractLeaseVersionDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 */
public class ContractLeaseVersionDaoImpl extends BaseBusinessModelDaoImpl<ContractLeaseVersion> implements ContractLeaseVersionDao {
