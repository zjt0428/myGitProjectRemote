/**
 *====================================================
 * 文件名称: ContingencyPlanDaoImpl.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
...
/**
 * @ClassName: ContingencyPlanDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2014-4-20 上午8:22:32
 */
public class ContingencyPlanDaoImpl extends BaseBusinessModelDaoImpl<ContingencyPlan> implements ContingencyPlanDao {
