...
/**
 * @ClassName: EquipInstallDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-14 下午1:25:10
 */
public class EquipInstallDaoImpl extends BaseBusinessModelDaoImpl<EquipInstall> implements EquipInstallDao {
