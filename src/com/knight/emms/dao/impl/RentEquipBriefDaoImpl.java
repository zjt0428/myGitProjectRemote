/**
 *====================================================
 * 文件名称: RentEquipBriefDaoImpl.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
...
/** 
 * @ClassName: RentEquipBriefDaoImpl 
 * @Description: TODO(这里用一句话描述这个类的作用) 
 * @author chenxy 
 * @date 2015年4月11日 下午11:14:12  
 */
public class RentEquipBriefDaoImpl extends BaseLongPKDaoImpl<RentEquipBrief> implements RentEquipBriefDao {
