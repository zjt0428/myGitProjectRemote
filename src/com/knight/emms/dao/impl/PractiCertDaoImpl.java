...
/**
 * @ClassName: PractiCertDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-4 上午11:03:46
 */
public class PractiCertDaoImpl extends BaseLongPKDaoImpl<PractiCert> implements PractiCertDao {
