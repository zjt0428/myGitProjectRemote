...
/** 
 * @ClassName: TeamsAccountDaoImpl 
 * @Description: TODO(这里用一句话描述这个类的作用) 
 * @author chenxy 
 * @date 2015年3月31日 上午12:18:19  
 */
public class TeamsAccountDaoImpl extends BaseLongPKDaoImpl<TeamsAccount> implements TeamsAccountDao {
