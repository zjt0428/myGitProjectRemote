/**
 *====================================================
 * 文件名称: RentDeductBriefDaoImpl.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
...
/** 
 * @ClassName: RentDeductBriefDaoImpl 
 * @Description: TODO(这里用一句话描述这个类的作用) 
 * @author chenxy 
 * @date 2015年4月11日 下午11:13:58  
 */
public class RentDeductBriefDaoImpl extends BaseLongPKDaoImpl<RentDeductBrief> implements RentDeductBriefDao {
