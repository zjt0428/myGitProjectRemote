...
/**
 * @ClassName: VerifySelfDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2014-4-26 下午11:48:07
 */
public class VerifySelfDaoImpl extends BaseBusinessModelDaoImpl<VerifySelf> implements VerifySelfDao {
