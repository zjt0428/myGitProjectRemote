/**
 *====================================================
 * 文件名称: SettleContractDaoImpl.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
...
/**
 * @ClassName: SettleContractDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-9-24 下午5:08:05
 */
public class SettleContractDaoImpl extends BaseBusinessModelDaoImpl<SettleContract> implements SettleContractDao {
