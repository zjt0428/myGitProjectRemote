...
/**
 * @ClassName: DeductPractiDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-17 下午4:20:09
 */
public class DeductPractiDaoImpl extends BaseLongPKDaoImpl<DeductPracti> implements DeductPractiDao {
