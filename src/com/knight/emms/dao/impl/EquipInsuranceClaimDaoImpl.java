...
/**
 * @ClassName: InsureEquipDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-14 下午1:26:36
 */
public class EquipInsuranceClaimDaoImpl extends BaseLongPKDaoImpl<EquipInsuranceClaimRecord> implements EquipInsuranceClaimDao {
