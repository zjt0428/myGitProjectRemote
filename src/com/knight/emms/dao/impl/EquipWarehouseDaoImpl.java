/**
 *====================================================
 * 文件名称: EquipWarehouseDaoImpl.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
...
/**
 * @ClassName: EquipWarehouseDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2014-5-5 下午10:48:11
 */
public class EquipWarehouseDaoImpl extends BaseBusinessModelDaoImpl<EquipWarehouse> implements EquipWarehouseDao {
