...
/**
 * @ClassName: PractitionerDaoImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-4 上午11:04:05
 */
public class PractitionerDaoImpl extends BaseLongPKDaoImpl<Practitioner> implements PractitionerDao {
