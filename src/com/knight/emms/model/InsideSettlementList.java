...
@Entity
@Data
@ToString(exclude = {"insideId"})
@EqualsAndHashCode(callSuper = false, exclude = {"insideId"})
@Table(name = "T_INSIDE_SETTLEMENT_LIST")
public class InsideSettlementList extends BaseModel {
