...
<%
	...
	Long overduePaymentId = (Long) request.getAttribute("overduePaymentId");
%>
<html>
<head>
<base target="_self">
...
<body>
	...
	<script type="text/javascript">
		...
		function doSave(){
			if (confirm("是否提交催款函信息？")) {
				var content = UE.getEditor('editor').getContent();
				document.getElementById("content").value=content;
				document.form1.action="printOverduePayment.do?formpage=OverduePayment&EVENT=SAVE&overduePaymentId=<%=overduePaymentId%>";
		...
		function doPrint(){
			var content = UE.getEditor('editor').getContent();
			document.getElementById("content").value=content;
			document.form1.action="printOverduePayment.do?formpage=OverduePayment&EVENT=PRINT&overduePaymentId=<%=overduePaymentId%>";
			document.form1.submit();
		}
