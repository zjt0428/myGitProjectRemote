...
<p style="text-align:right;"><strong>GDAQ21102&nbsp;&nbsp;</strong> <input name="" type="text" style="width:80px; border:1px solid #000000;"/><br /><br /></p>
<p><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:18px; font-family:"宋体"">
  <tr>
    <td width="250" align="center" style="font-size:18px;">
    	<u><strong>${indisSchema.blockNumber}塔吊安装<br/>施工方案</strong></u>
    </td>
