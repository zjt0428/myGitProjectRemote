...
<p style='text-align:center'><span class="wrod_title">塔式起重机设备出货清单</span></p>
<p>
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-bottom:5px;padding-top:10px;">
  <tr>
    <td width="200" height="30" align="left">塔式起重机：${dispatchEquip.equipment.recordId }</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="chqdtable" style="border-top-style:none;">
  ...
  <c:forEach var="element" items="${dispatch.towerCraneDispatchAllocateSet}" varStatus="status" >
  <tr>
    <td>&nbsp;${status.count}</td>
