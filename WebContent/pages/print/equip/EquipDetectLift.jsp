...
<title>施工升降机_安装质量检测（验收）资料汇总表</title>
...
<p style='text-align:center;'><span class="wrod_title">（施工升降机）</span></p>
<p>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-top-style:none;" class="jljc_table">
  ...
  <tr>
    <td rowspan="4" align="center">基础及附着<br />
      部位</td>
  ...
  <tr>
    ...
    <td align="left">若基础下有地下空间，基础的支承体已经计算合格或得到加强，有防护措施</td>
  </tr>
  <tr>
    <td rowspan="3" align="center">自检记录</td>
    <td align="center">8</td>
    <td align="left">金属结构及联接、驱动装置、电气保护、附着系统、对重及钢丝绳等</td>
  </tr>
  <tr>
    <td align="center">9</td>
    <td align="left">空载及载荷试验正常</td>
  </tr>
  <tr>
    <td align="center">10</td>
    <td align="left">坠落试验正常</td>
  </tr> 
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  class="jljc_table" style="border-top-style:none;">
  <tr>
    <td width="33%" align="left"><p>施工总承包单位意见： <br />
	  ...
	  7<input type="checkbox" name="checkbox" value="checkbox" /></p>
      <p>&nbsp;</p>
      <p>负责人： </p>
      日期：         （单位盖章）</td>
    ...
    <td align="left"><p>安装单位意见： <br />
	  ...
	  9<input type="checkbox" name="checkbox" value="checkbox" />
	  10<input type="checkbox" name="checkbox" value="checkbox" />  
	  </p>
      <p>&nbsp;</p>
      <p>负责人： </p>
      日期：          （单位盖章）</td>
  ...
  <tr>
    <td colspan="3" align="left"><p><strong>备注：</strong>1、本表由施工升降机安装、分包（使用）及施工总承包单位填写并盖章。分包（使用）单位须查阅安装单位的上述证书、证件及序号1、2项的内容；安装单位确认本表所有内容；施工总承包单位审查安装单位的上述证书、证件及确认序号1、2项和序号4至7项的内容。 <br />
      2、盖章单位应详细审核资料，对填写内容的真实性负责。 </p>
      3、本表一式四联，设备检测时，一联交检测机构备案，其余各单位留存一联</td>
    </tr>
</table>
