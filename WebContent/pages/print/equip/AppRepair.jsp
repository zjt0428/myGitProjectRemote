...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="hzb_table">
  <tr>
    ...
    <td width="300">&nbsp;${appRepair.createByname }</td>
    <td width="100">填报日期</td>
    <td width="300">&nbsp;<fmt:formatDate value="${appRepair.repairDt}" pattern="yyyy-MM-dd" /></td>
    <td width="100">填报部门</td>
    <td width="250">&nbsp;</td>
<%--     ${appUser.department.depName }</td> --%>
  </tr>
  <tr>
    <td height="30">项目名称</td>
    <td>&nbsp;${appRepair.projectName}</td>
    <td>设备名称</td>
    <td>&nbsp;${appRepair.equipGenericName}</td> 
    <td>规格型号</td>
    <td>&nbsp;${appRepair.equipSpec}</td>
  </tr>
  <tr>
    <td height="30">出厂编号</td>
    <td>&nbsp;${appRepair.exwSerial}</td>
    <td>项目地址</td>
    <td>&nbsp;${appRepair.location}</td>
    <td>现场编号</td>
    <td>&nbsp;${appRepair.buildingNum}</td>
  </tr>
  <tr>
    <td height="30">备案编号</td>
    <td>&nbsp;${appRepair.recordSerial}</td>
    <td>车牌号</td>
    <td>&nbsp;</td>
    <td>主修人员</td>
    <td>&nbsp;${appRepair.procMan}</td>
  </tr>
  <tr>
    <td rowspan="4">故障<br />
      描述</td>
    <td colspan="3" rowspan="4">&nbsp;${appRepair.faultDesc}</td>
    <td height="30">协助人员</td>
    <td>&nbsp;</td>
  </tr>
 <tr>
    <td height="30">运行状态</td>
    <td>&nbsp;${appRepair.stateName}</td>
  </tr>
  <tr>
    <td height="30">维修结果</td>
    <td>&nbsp;${appRepair.procResult}</td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="hzb_table" style="border-top-style:none;"> 
  ...
  <c:forEach var="element" items="${appRepair.appRepairLocationSet}" varStatus="status" >
  <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="hzb_table" style="border-top-style:none;"> 
  ...
  <c:forEach var="element" items="${appRepair.appRepairNewComponSet}" varStatus="status" >
  <tr>
