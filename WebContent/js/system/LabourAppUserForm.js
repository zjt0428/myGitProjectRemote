	var LabourAppUserForm = function(a, b) {
	Ext.apply(this, a || {});
	Ext.apply(this, b || {});
	this.saveable = this.saveable; // 保存/重置功能按钮

	var depSelector = new TreeSelector("depTreeSelector", __ctxPath + "/system/listLabourDepartment.do?opt=appUser", "所属部门", "appUser.depId",false);
	...
	LabourAppUserForm.superclass.constructor.call(this, {
		width : 660,
...
Ext.extend(LabourAppUserForm, Knight.ux.FormPanelWindow, {
