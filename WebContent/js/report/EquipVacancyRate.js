var EquipVacancyRate = function(a) {
	this.params = {};
	...
	EquipVacancyRate.superclass.constructor.call(this, {
		id : "EquipVacancyRate",
		title : "设备闲置率统计表",
		iconCls : "menu-business-equipmargin",
		jasperFile : "REPORT_EQUIP_VACANCY_RATE",
		search_config : {
			preLableHidden : true,
...
Ext.extend(EquipVacancyRate, Knight.ux.BaseReportView, {});
