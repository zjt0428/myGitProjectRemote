var SettleMaterialsQuery = function(a){
	this.params = {};
	...
	SettleMaterialsQuery.superclass.constructor.call(this,{
		id : "SettleMaterialsQuery",
		title : "周材结算查询",
		iconCls : "menu-business-practivacancyrate",
		jasperFile : "REPORT_SETTLE_MATERIALS_QUERY",
		search_config : {
...
Ext.extend(SettleMaterialsQuery, Knight.ux.BaseReportView, {
	...
	queryDetail : function() {
		...
		new SettleMaterialsDetailWindow({
			params : {
				relateModule : RelationModule.settleMaterials.relateModule,
