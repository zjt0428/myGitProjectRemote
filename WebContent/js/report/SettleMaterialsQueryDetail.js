var SettleMaterialsQueryDetail = function(a){
	this.params = {};
	...
	SettleMaterialsQueryDetail.superclass.constructor.call(this,{
		id : "SettleMaterialsQueryDetail",
		title : "周材结算明细查询",
		iconCls : "menu-business-practivacancyrate",
		jasperFile : "REPORT_SETTLE_MATERIALS_QUERY_DETAIL",
		search_config : {
...
Ext.extend(SettleMaterialsQueryDetail, Knight.ux.BaseReportView, {
