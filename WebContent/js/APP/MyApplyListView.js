var MyApplyListView = function(a) {
	Ext.apply(this, a || {});
	this.params = {};
	this.userId = "";
	...
	MyApplyListView.superclass.constructor.call(this, Ext.apply({
		id : "MyApplyListView",
		title : TabTitle.MYAPPLYLIST_VIEW,
		iconCls : "menu-info",
		url : __ctxPath + "/app/listFlow.do?TYPE=1&userId="+this.userId,
...
Ext.extend(MyApplyListView, Knight.ux.SearchGridPanel, {
	initTopBarActionItems : function() {
		var tbarItems = [];
		tbarItems.push("->");
		if (isGranted("_MyApplyExporter")) {
			tbarItems.push({
