var DispatchEquipInstallForm = function(a, b) {
	Ext.apply(this, a || {});
	Ext.apply(this, b || {});
	this.saveable = this.saveable; // 保存/重置功能按钮
	DispatchEquipInstallForm.superclass.constructor.call(this, a, b);
};
Ext.extend(DispatchEquipInstallForm, DispatchForm, {
...
//					continue;
//				}
//				if (this.dispatchComponGrid.getStore().getAt(j).data.componId == data.componId && data.consumeFlag == "0") {
