var DispatchAllocateInitSelector = function(a) {
	Ext.apply(this, a || {});
	this.params = {};
	...
	var generalItems = [ {
		...
		lable : "配件类别",
		name : "Q_initStatus_S_LK"
	} ];
	var datagrid_config = {
		single : this.single,
		store : {
			sortField : "disAllInitId",
			sortDir : "asc",
			id : "disAllInitId",
			fields : DispatchAllocateInitListViewField
		},
		columns : [  {
			width : 100,
			header : "配件类别",
...
Ext.extend(DispatchAllocateInitSelector, Knight.ux.RelationSelector, {
