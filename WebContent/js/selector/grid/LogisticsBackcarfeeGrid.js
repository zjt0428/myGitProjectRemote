var LogisticsBackcarfeeGrid = function(a, b) {
	Ext.apply(this, a || {});
	Ext.apply(this, b || {});
	...
	var columns = [ {
		...
		editor : new Ext.form.NumberField({
			...
			if(record.data.motorcoach&&record.data.unitPrice){
	...
	LogisticsBackcarfeeGrid.superclass.constructor.call(this, Ext.apply({
		saveable : this.saveable,
		fields : LogisticsBackcarfeeListViewField,
		title : "运输费清单",
		option : "运输费清单",
		tbarItems : this.tbarItems,
		height : this.height,
		columns : columns,
		delurl : __ctxPath + "/dispatch/multiDelBackcarfeeLogisticsBacksport.do"
	}, this.grid_config || {}));
};
Ext.extend(LogisticsBackcarfeeGrid, Knight.ux.SubModuleBaseGrid, {
