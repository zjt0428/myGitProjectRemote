var SupplierLinkerGrid = function(a, b) {
	Ext.apply(this, a || {});
	Ext.apply(this, b || {});
	...
	SupplierLinkerGrid.superclass.constructor.call(this, Ext.apply({
		saveable : this.saveable,
		selectable : this.selectable,
		fields : SupplierLinkerListViewField,
		title : "供应商联系人信息",
		option : "供应商联系人",
		...
		delurl : __ctxPath + "/archive/multiDelLinkerSupplier.do"
	}, this.grid_config || {}));
};
Ext.extend(SupplierLinkerGrid, Knight.ux.SubModuleBaseGrid, {
