var TechnicalDisclosureSelector = function(a) {
	Ext.apply(this, a || {});
	this.params = {};
	...
	TechnicalDisclosureSelector.superclass.constructor.call(this, {
		height : 700,
		width : 500,
		configView : {
			title : "合同选择"
...
Ext.extend(TechnicalDisclosureSelector, Knight.ux.RelationSelector, {
	selectAll : function() {
		//获取查询条件 params
