 ...
 * All right reserved. 
 *====================================================
 * 文件名称: AppUserKeyExtendService.java
 * 修订记录：
 * No    日期				作者(操作:具体内容)
...
/**
 * @ClassName: AppUserKeyExtendService
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author chenxy
 * @date 2013-7-3 下午5:37:34
 */
public interface AppUserKeyExtendService extends BaseLongPKService<AppUserKeyExtend> {
