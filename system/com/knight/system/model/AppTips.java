...
public class AppTips extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.tipsId, rhs.tipsId).append(this.tipsName, rhs.tipsName).append(
				this.content, rhs.content).append(this.disheight, rhs.disheight).append(this.diswidth,
				rhs.diswidth).append(this.disleft, rhs.disleft).append(this.distop, rhs.distop).append(
				this.dislevel, rhs.dislevel).append(this.createTime, rhs.createTime).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.tipsId).append(this.tipsName).append(
				this.content).append(this.disheight).append(this.diswidth).append(this.disleft)
				.append(this.distop).append(this.dislevel).append(this.createTime).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("tipsId", this.tipsId).append("tipsName", this.tipsName).append(
				"content", this.content).append("disheight", this.disheight).append("diswidth", this.diswidth)
